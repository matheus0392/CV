...
{\cityQC, \countryCN \remoto}{Paradigme3 {\refCinco{https://paradigme3.ca/}}}{\pt{Desenvolvedor Full Stack}\fr{Analyste Programmeur }\en{Programmer Analyst}}{\outubro 2022 -- \atual}{\pt{}\fr{Services-conseils en TI}\en{IT Consulting Services}}{}{
  \vspace{-0.4cm}
    \cventry{\junho 2024 -- \atual}{\ \ \ \ \ \ Mandate: Ministère de la Santé et des Services sociaux}{}{}{project: modernization WSTAT}{}{
        ...
        \end{itemize}
        \vspace{0.4cm}
        \hspace{1cm}\ambiente{Angular (TypeScript, PrimeNg, Bootstrap), Java 17 (Quarkus, Maven, JUnit, Hibernate), Git, Pull Requests review, Docker, Kubernetes, REST, Swagger, Azure Devops.}% ,  Agile, Azure Data Studio, VScode, IntelliJ, Microsoft Teams. }
    }
    \\
...
\cventry{\citySP, \countryBR \remoto}{Stefanini Group \refQuatro}{FullStack \desenvolvedor}{\junho 2021 -- \outubro 2022}{\translate{Global Tech Consultancy}{Conseil en stratégie digitale}{}}{}{
    ...
    \begin{adjustwidth}{1cm}{0cm}
        ...
        \end{itemize}
        \bigskip
        \ambiente{AngularJS (JavaScript, Bootstrap, Grunt, Karma, JasmineJS), Angular (TypeScript, PrimeNg, PrimeFlex, Karma, JasmineJS), Java (Quarkus, Maven, JUnit), Docker, Artifactory, Kubernetes, Rancher, ArgoCD, VScode, SonarQube, Highcharts, Git, REST, Jenkins.} %, Swagger, Eclipse, Git, Gitlab,, DBeaver, Agile, VMware Virtual Desktop Infrastructure (VDI), Microsoft Teams. }
    \end{adjustwidth}
}
\bigskip
\bigskip
...
% ------------- experiencia ------------- 
\cventry{\citySP, \countryBR \remoto}{Gauge - Stefanini Group \reff{https://gauge-next-challenge.vercel.app/}}{FullStack \desenvolvedor}{\setembro 2020 -- \junho 2021}{\translate{Digital Consulting}{Conseil en stratégie digitale}{}}{}{
    \vspace{1mm}
    \begin{adjustwidth}{1cm}{0cm}
        \underline{\projeto: Yazigi Yconnect} - \translate{Online platform for foreign language courses belonging to the Pearson group. The platform has about 70k students per year and receives more than 5M of access per month}{Plateforme en ligne pour les cours de langues étrangères appartenant au groupe Pearson. La plateforme compte environ 70k étudiants par an et reçoit plus de 5M d’accès par mois}{Plataforma online para cursos de línguas estrangeiras que pertence ao grupo Pearson. A plataforma possui cerca de 70k alunos por ano e recebe mais de 5M de acesso por mês}.
        \medskip
        \begin{itemize}[leftmargin=1cm, parsep=0.1cm, topsep=0.2cm]
             ...
             \item{\translate{Created correction SQL scripts for the database for activities and media}{Avez Créé des scripts SQL de correction pour la base de données pour les activités et medias}{Criou scripts SQL de correção para banco de dados para as atividades e mídias};}
        ...
        \end{itemize}
        \ambiente{ ReactJS (TypeScript, Axios, Bootstrap), Microsoft SQL Server, Bitbucket, Gitflow, Pull Requests review, Agile.} % Asana, VScode, TaskRow, JIRA.
        \bigskip
        \\
        \underline{\projeto: Wizard Wiz.Tab} - \translate{Android application for foreign language courses belonging to the Pearson group. The application has more than 100k downloads}{Application Android pour les cours de langues étrangères appartenant au groupe Pearson. L’application a plus de 100k téléchargements}{Aplicativo Android para cursos de idiomas estrangeiros pertencente ao grupo Pearson. O aplicativo possui mais de 100k downloads}.
        \medskip
        \begin{itemize}[leftmargin=1cm, parsep=0.1cm, topsep=-0.25cm]
             \item{\translate{Answer customers's requests recorded in serviceNow regarding the production environment and make corrections to the Wiz Tab mobile app}{Répondre aux demandes des clients enregistrés sur serviceNow par rapport à l’environnement de production et effectuer les corrections à la application mobile Wiz Tab}{Atender às solicitações dos clientes registradas no serviceNow em relação ao ambiente de produção e fazer correções para o aplicativo móvel Wiz Tab};}
            \item{\translate{Updated the version in the Google Play Store and made deploys in AWS serveless}{Mise à jour de la version dans le Google Play Store et déploiement sur AWS serveless}{Atualizou a versão na Google Play Store e fez implantações no AWS serveless}}
        \end{itemize}
        \bigskip
...
\cventry{\cityBSB, \countryBR}{NExT UnB \refDois }{{\desenvolvedor} WEB}{\agosto 2018 -- \setembro 2020}{\pt{Núcleo de Pesquisa e Desenvolvimento para Excelência e Transformação do Setor Público (UnB)} \fr{Centre de recherche et développement pour le secteur public (UnB)}\en{Research and Development Center for Excellence and Transformation of the Public Sector}}{}{
    ...
    %\cventry{1}{}{projeto evobiz ticshealth}{agosto 2018 -- janeiro 2020 }{}{6}{7}
        ...
        \end{itemize}
        \bigskip
        \ambiente{Java (Spring Boot, JPA, Maven, Criteria Query), ReactJS \& React Native (Axios, Bootstrap), PostgreSQL, REST, Docker, Git, Firebase, Eslint.} %JavaScript, Eclipse, VScode,  Postman}
        \bigskip
